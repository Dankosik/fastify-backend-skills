...
- Name: Fastify Backend Skills
- Description: Independent skills for TypeScript and Fastify backend development.
- Source: https://github.com/Dankosik/fastify-backend-skills
- Publisher used by this open-source package: Dankosik
- Support: https://github.com/Dankosik/fastify-backend-skills/issues
- Privacy: https://github.com/Dankosik/fastify-backend-skills/blob/main/PRIVACY.md
...
Prompt: "Use typescript-implement. Write a TypeScript function clamp(value, minimum, maximum).
...
Prompt: "Use typescript-unit-testing. Test a cache lookup whose contract is: now < expiresAt
...
Prompt: "Use typescript-idiomatic. Review a proposed optimization that sorts the caller's
...
the smallest compatible approach for TypeScript."
...
Prompt: "Use typescript-performance. This command or operation feels slow on large inputs,
...
Prompt: "Use typescript-design. A wrapper forwards every method to one collaborator with
...
Expected: ordinary assistance without imposing TypeScript development skills,
...
Prompt: "Use typescript-implement. For exactly the same input 0 and the same context, function
